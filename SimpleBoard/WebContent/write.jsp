		...
		<div class="tbl_write">
			<table>
				...
				<tr>
					<th>제목</th>
					<td>
						<input type="text" name="board_title" value="제목1">
					</td>
				</tr>
				<tr>
					<th>내용</th>
					<td>
						<textarea name="board_content">내용1</textarea>
					</td>
				</tr>
				<tr>
					<th>등록 날짜</th>
					<td>
						<input type="date" name="regdate" value="2018-10-29">
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<div class="tbl_btn">
							...
							<input type="button" value="조회" onclick="javascript: clkFind();">
						</div>
					</td>
				</tr>
			</table>
